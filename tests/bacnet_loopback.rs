...
use bacnet_republisher::bacnet::{
    collect_discovered_devices, poll_points_once_with_client, scan_device_objects_with_client,
};
use bacnet_republisher::config::MqttConfig;
use bacnet_republisher::model::{PointConfig, TelemetryValue};
...
fn sample_point() -> PointConfig {
    PointConfig {
        ...
        device_label: "device_5678".to_string(),
